(* OASIS_START *)
(* DO NOT EDIT (digest: a1a7f9282503c9a027b428c6d85b2b99) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("lib/Fuse", ["lib"])];
     lib_c = [("Fuse", "lib", ["lib/Fuse_bindings.h"])];
     flags =
       [
          (["oasis_library_fuse_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S
                   [
                      A "-ccopt";
                      A "-D_FILE_OFFSET_BITS=64";
                      A "-ccopt";
                      A "-pthread"
                   ])
            ]);
          (["oasis_library_fuse_cclib"; "link"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_fuse_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true,
                 S [A "-lfuse"; A "-L/usr/lib/ocaml"; A "-lcamlidl"])
            ]);
          (["oasis_library_fuse_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-linkall"])]);
          (["oasis_library_fuse_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-linkall"])]);
          (["oasis_library_fuse_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-linkall"])]);
          (["oasis_library_fuse_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-linkall"])]);
          (["oasis_library_fuse_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-linkall"])]);
          (["oasis_library_fuse_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-linkall"])])
       ];
     }
  ;;
