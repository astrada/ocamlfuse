...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5ad6f778250677a24cc3986cf24b1c0e) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("make", ["-C"; "lib"; "INCDIRS=$pkg_camlidl"]))
              ];
     ...
     install =
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("make", ["-C"; "lib"; "install"]))];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)]
         };
     uninstall =
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("make", ["-C"; "lib"; "uninstall"]))];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)]
         };
     clean =
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "H\134x\244*\240x}\2102\146\158\248\011M\154";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
