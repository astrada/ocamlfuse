...
(* OASIS_START *)
(* DO NOT EDIT (digest: a101ce7754d789f5d3661ba7305446bc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some
              "http://sourceforge.net/apps/mediawiki/ocamlfuse/index.php?title=Main_Page";
            ...
            [
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_cclib =
                        [
                           (OASISExpr.EBool true,
                             ["-lfuse"; "-L/usr/lib/ocaml"; "-lcamlidl"])
                        ];
                   ...
                   {
                      lib_modules = ["Fuse"; "Fuse_bindings"; "Unix_util"];
                      lib_pack = false;
                      lib_internal_modules = ["Result"; "Fuse_lib"];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "Fuse"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "fusexmp.ml"; })
            ];
     ...
     oasis_digest = Some "\134d\175c$*o\213\247\000\139\r\164\166\003\221";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
